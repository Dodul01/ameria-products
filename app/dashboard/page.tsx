...
import { CrownIcon, LineChartIcon, EyeIcon, BanIcon, UsersRoundIcon, Ban, LockOpen } from "lucide-react"
                                ...
                                {filteredUsers.map((user, idx) => (
                                    <TableRow key={idx}>
                                        ...
                                        <TableCell>
                                            <Badge
                                                variant="outline"
                                                className={`px-2 ${user.status === "Active"
                                        ...
                                        <TableCell className="text-center space-x-2">
                                            ...
                                            <ConfirmationAlert
                                                ...
                                                onConfirm={user.status === "Active" ? handleDelete : handleBlock}
